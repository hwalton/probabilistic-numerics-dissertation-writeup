...
\begin{document}
    ...
    \subsection{Time Plan and Schedule for Future Work}
    Below is a Gantt chart outlining the main steps and the approximate schedule for the remaining work in the project:

    \begin{figure}[htbp]
        \centering
        \includegraphics[width=\textwidth]{figures/gantt_chart/gantt_chart.png}
        \caption{A Gantt chart to show the time plan of the rest of the project}
