...
\begin{document}
    ...
    This was plotted as two functions of time, from which a small set of 100 samples was selected from the centre (to reduce computation time initially) was used as time series data to be fit by the GP\@ as shown in Figure~\ref{fig:input-response-plot}.
