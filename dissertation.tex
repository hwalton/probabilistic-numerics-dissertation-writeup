...
\begin{document}
    ...
    This process can be visualised as finding the area underneath the curve between 2 input values (Figure~\ref{fig:ndi}).
    ...
    This states that an integral can be approximated by summing the area of many adjacent rectangles between the function and the axis~\cite{NumericalAnalysis2023}, as shown in Figure~\ref{fig:ndi-num} and Figure~\ref{fig:ndi-num2}.
    As you can see

    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{figures/ndi-num/ndi-num.png}
        \caption{The rectangle method for }
        \label{fig:ndi-num}
    \end{figure}

    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{figures/ndi-num2/ndi-num2.png}
        \caption{The rectangle method for }
        \label{fig:ndi-num2}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{figures/ndi/ndi.png}
        \caption{Definite integral of the Gaussian (normal) distribution. Used to find cululative probabilities}
        \label{fig:ndi}
    \end{figure}
