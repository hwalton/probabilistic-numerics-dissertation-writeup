...
\begin{document}
    ...
    For example, the error bound of a stiffness could be represented as $0.1 \pm 0.02 Nm^{-1}$, which provides a range bounded by an upper and lower limit which the true value is expected to be within.
