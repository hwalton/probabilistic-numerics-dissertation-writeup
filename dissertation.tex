...
%    \end{longtable}
    ...
    where $f^*$ is an array of values of the latent function evaluated at a set of test points $X_*$ and $K_{X,X}$, $K_{X,*}$ \& $K_{*,*}$ are a type of covariance matrix called a ``Kernel''.
