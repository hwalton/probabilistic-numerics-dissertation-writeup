...
%    \end{longtable}
    ...
    \nomenclature[L]{$\mathbf{y}_n$}{Noisy observed output based on the latent function, $\mathbf{f}(\mathbf{x})$}
    \nomenclature[L]{$\mathbf{y}$}{A vector of $\mathbf{y}_n$ values from a set of training points}
