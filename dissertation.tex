...
\begin{document}
    ...
    \begin{enumerate}
        ...
        Therefore, to make structures safer and reduce maintenance costs, it would be valuable to be able to identify the inherent dynamic properties of a system such as this resonant frequency from system parameters such as the stiffness of the tower so that the frequencies at which they occur can be designed away from the expected frequencies of the periodic forces.
    ...
    Nonlinearity can even cause bifurcations, where the system can exhibit one of multiple stable responses, or limit cycles, at a given frequency.
    ...
    What's worse is that typically not even these system parameters are known, so medium to highly non-linear systems all that can be done is to take real life data measurements from an existing system and identify the system parameters with a technique known as inverse modelling.
    ...
    Similarly, certain algorithms make use of a mathematical object called a matrix pseudoinverse which have multiple alternatives, the correct choice of which is arguable and not definitive.
