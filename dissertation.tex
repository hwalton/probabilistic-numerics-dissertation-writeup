...
\begin{document}
    ...
    The comparison of the two approaches is done in the context of modal analysis of a Multi-Degree of Freedom (MDOF) system, which is when the vibration of a structure is analysed in response to a force signal in order to find its damping ratios, resonant frequencies, and the shapes that the structure vibrates at these frequencies (modeshapes).
    A mo
