...
\begin{document}
    ...
    This is because certain matrix operations such as determinants and inversions can give imprecise results for large matrices containing floating point numbers (a format that computors use to store continuous variables as a decimal, (as opposed to integers type variables)).
