...
\begin{document}
    ...
    \begin{enumerate}[listparindent=\parindent]
        ...
        Studying this dynamic system would be beneficial as it may allow for the prediction of behavior based on varying these parameters which would enable optimisation without trial and error, conserving resources during the research and development phase of the product lifecycle.
