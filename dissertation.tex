...
\begin{document}
    ...
    \section{Conclusions}
    \textcolor{red}{Overall the new method of computing the Fourier Transform of time domain data using a GP was shown to have better?? robustness to noise than the Fast Fourier Transform(FFT)  several promising features}
